...
export const Gateway: React.FC = () => {
  useEffect(() => {
    // We can handle side effects here if needed in the future
    // For example, redirecting based on browser language if we wanted to
  }, []);
    ...
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', width: '100%' }}>
      ...
      <div className="cards-grid">
        ...
        <a href="https://lexipaws.sk" className="language-card active-card" onClick={() => setLanguage('sk')}>
          <div className="flag-icon">
            {/* Custom SVG Slovak Flag icon (round) */}
            <svg viewBox="0 0 100 100" width="80" height="80">
              <clipPath id="sk-clip">
                <circle cx="50" cy="50" r="50"/>
              </clipPath>
