...
export const TypeIn: React.FC<TypeInProps> = ({ question, onAnswer }) => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Check answer cleanly (case insensitive, trim spaces)
  ...
  // Format the sentence to have a clear place to type, but for a type_in, we might just show an input field below.
  ...
  return (
    <div style={{ width: '100%', maxWidth: '600px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <div style={{
        ...
        {/* We replace the ____ with an inline input field if it exists in the sentence */}
