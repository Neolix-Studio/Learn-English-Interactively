...
export const learningContent: Record<string, any> = {
    A1: {
        FirstEncounters: {
            title: "Ital rendelés (Ordering a Drink)",
            title_hu: "Ital rendelés",
            title_en: "Ordering a Drink",
            title_sk: "Objednávka nápoja",
            explanation: "Tanulj meg alapvető kávézós szavakat és hogyan rendelj italt!",
            type: "multi_level_node",
            dataSource: "data/A1/Module_1_Hello_World/node1_ordering_a_drink.json",
            totalLessons: 4
        },
        Basics1: {
            title: "Alapok 1: Szavak és Tárgyak (Basic Nouns)",
            title_hu: "Alapok 1: Szavak és Tárgyak",
            title_en: "Basics 1: Nouns & Objects",
            title_sk: "Základy 1: Slová a predmety",
            explanation: "Mielőtt belevágunk a nyelvtanba, tanuljunk meg néhány alapvető szót!",
            subsections: {
                words: {
                    title: "Szavak",
                    icon: "📖",
                    type: "words",
                    dataSource: "data/A1/Basics1_Nouns/words.json"
                },
                practice: {
                    title: "Gyakorlás (Kávézó)",
                    icon: "🏋️",
                    type: "dynamic_practice",
                    dataSource: "data/A1/Basics1_Nouns/level1.json"
                },
                practice2: {
                    title: "Gyakorlás (Emberek)",
                    icon: "🏋️",
                    type: "dynamic_practice",
                    dataSource: "data/A1/Basics1_Nouns/level2.json"
                }
            }
        },
        Basics2: {
            title: "Alapok 2: Tulajdonságok (Adjectives)",
            title_hu: "Alapok 2: Tulajdonságok",
            title_en: "Basics 2: Adjectives",
            title_sk: "Základy 2: Vlastnosti",
            explanation: "Tanuljuk meg hogyan jellemezzünk dolgokat és embereket!",
            subsections: {
                words: {
                    title: "Szavak",
                    icon: "📖",
                    type: "words",
                    dataSource: "data/A1/Basics2_Adjectives/words.json"
                },
                practice: {
                    title: "Gyakorlás",
                    icon: "🏋️",
